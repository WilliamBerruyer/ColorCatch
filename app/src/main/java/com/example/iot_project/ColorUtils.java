...
public class ColorUtils {
    ...
    public String colorToRGB(String hex) {
        ...
        String rS = String.valueOf(ret[0]);
        String gS = String.valueOf(ret[1]);
        String bS = String.valueOf(ret[2]);
    ...
    public String colorToHsv(String hex) {
        ...
        Color.RGBToHSV(r, g, b, lHSB);

        String rS = String.valueOf(lHSB[0]);
    ...
    public String rgbToCmyk(String hex) {
        ...
        int[] tab = rgbToCmykInt(r, g, b);

        String rS = String.valueOf(tab[0]);
        String gS = String.valueOf(tab[1]);
        String bS = String.valueOf(tab[2]);
        String dS = String.valueOf(tab[2]);
